...
var redeempaper = async function(orgName, funcName, args) {
  ...
  try {
    ...
    const redeemResponse = await contract.submitTransaction(funcName, orgName, args[0], args[1], args[2]);
                      //args[0] ----> papernumber
                      //args[1] ----> buyer
                      //args[2] ----> expirydate
    // process response
...
exports.redeempaper = redeempaper;