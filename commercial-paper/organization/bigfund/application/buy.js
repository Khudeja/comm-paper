...
const wallet = new FileSystemWallet('../identity/user/mike/wallet');

// Main program function
var buypaper = async function(orgName, funcName, args)
  {
  ...
  try {
    ...
    const buyResponse = await contract.submitTransaction(funcName, orgName, args[0], args[1], args[2], args[3], args[4]);
    //args[0] ----> paperNumber
    //args[1] ----> issuer
    //args[2] ----> buyer
    //args[3] ----> facevalue
